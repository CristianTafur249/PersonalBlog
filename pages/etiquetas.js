          ...
          {sortedTags.map((t) => {
            return (
              <div key={t} className="-mt-2 m-auto  mb-2 w-full mr-5">
                <Tag
                  text={t}
                  clas="transition ease-in-out duration-700 hover:border-b-2 mx-2 rounded-full uppercase  m-auto my-1 p-1 text-center text-green-700 dark:text-green-400 hover:border-gray-800 hover:text-blue-800 "
                />
