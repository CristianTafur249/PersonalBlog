    ...
    return(
        <>
            ...
            <div className="divide-y divide-gray-200  ">
                <div className="space-y-2 pt-6 pb-8 md:space-y-5 border-b">
                ...
                <div className=" border-t items-start space-y-2 xl:grid xl:grid-cols-3 xl: gap-x-8 xl:space-y-0">
                    <div className=" flex flex-col items-center pt-8">
                        ...
                        <div className="prose max-w-l:col-span-2">
                            {children}
                        </div>
                    </div>
