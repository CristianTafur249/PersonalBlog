...
draft: false
images: ['/static/images/instalacion-kvm/kvm-ok.png','/static/images/instalacion-kvm/installKVM.png','/static/images/instalacion-kvm/isActive.png','/static/images/instalacion-kvm/USER.png']
authors: ['tafur']
...
Para instalar KVM, se debe tener como principal prerrequisito que el host sea compatible con la virtualización KVM. Para revisar si esto es compatible, se debe utilizar el comando:
...
![kvm-ok](/static/images/instalacion-kvm/kvm-ok.png)
...
```
![installKVM](/static/images/instalacion-kvm/installKVM.png)
...
```
![isActive](/static/images/instalacion-kvm/isActive.png)
...
Para poder crear y administrar máquinas virtuales se debe agregar el usuario a los grupos libvirt y kvm de la siguiente forma:
    ...
    ![USER](/static/images/instalacion-kvm/USER.png)
