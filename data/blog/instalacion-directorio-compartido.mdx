---
title: "Instalacion de directorios comparidos usando samba"
date: '2023-04-13'
lastmod: '2023-04-13'
tags: ['Linux', 'Virtualizacion', 'compartición de archivos','samba', 'servidores', 'Software libre']
draft: false
...
```
![restart](https://drive.google.com/uc?export=view&id=1zU8ZSD2FBUGnb-5sg3Marh-7Wog5VQmq)
8. En el sistema anfitrión, abre un explorador de archivos y escribe en la barra de direcciones:

*\ \ {`<ip_de_la_vtm>`} \ \ {`<nombre_compartido>`}* 
